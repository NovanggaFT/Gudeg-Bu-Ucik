// app/components/form/SalesForm.tsx
...
export default function SalesForm({ 
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (value > targetHarian * 2) {
      setError(`Penjualan terlalu tinggi (maks ${targetHarian * 2} porsi)`);
      return;
    }
        ...
        <div className="bg-white rounded-2xl shadow-2xl mx-4 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
            ...
            <p className="text-xs text-gray-400 mt-1">
              Hari ke-{hariKe} · {tanggal} · target {targetHarian} porsi/hari
            </p>
          </div>
